...
L["Clicking this button will attempt to join the ongoing Live Session of your group or create a new one if none is found"] =
  "Clicke auf diesen Button um zu versuchen einer laufenden Live Sitzung deiner Gruppe beizutreten oder eine neue zu starten falls keine gefunden wurde"
...
L["dawnPortalNote"] =
  "Unendliche Rissmagierin 2 und 4 müssen besiegt werden, damit die Portale aktiviert werden. Temporalabweichung tauchen immer wieder auf, geben aber keine Streitkräfte."
...
L["LargePresetWarning"] =
  "Du versuchst eine sehr große Route zu teilen (%d Zeichen)%sEs wird stattdessen empfohlen die Export-Funktion zu verwenden um große Routen auf externen Websiten zu teilen oder Zeichnungen zu entfernen.%sBist du dir sicher diese Route zu teilen?%s"
...
L["MaggotNote"] =
  "Notiz zu Verschlingenden Maden:%s%sVerschlingende Maden mit dem Stärkungszauber 'Parasitisch' werden versuchen Spiler zu 'Infizieren'%sNach erfolgreichem Zauber von 'Infizieren' wird die Verschlingende Made verschwinden und 2x neue Verschlingende Maden beschwören, sobald der Schwächungszauber auf dem infiziertem Spieler ausläuft.%sNur die ursprüngliche Verschlingende Made zählt für Streitkräfte.%sInfizierte Arbeiter beschwören 3x Verschlingende Maden.%sDiese Verschlingende Maden sind neben den Infizierten Arbeitern verzeichnet."
L["Magic"] = "Magie"
...
L["MDT: Cannot add enemy - you are trying to add too many enemies of the same kind"] =
  "MDT: Gegner kann nicht hinzugefügt werden - Du versuchst zu viele Gegner des gleichen Typs hinzuzufügen"
...
L["Mouseover a patrolling enemy with a blue border to view the patrol path."] =
  "Bewege deine Maus über einen patroullierenden Gegner mit einer blauen Umrandung um den Patroullienweg zu sehen."
L["Mouseover the Live button while in a group to learn more about Live mode."] =
  "Bewege deine Maus über den Live Button, während du in einer Gruppe bist, um mehr über den Live Modus zu erfahren."
...
L["plaguefallDevotedNote"] =
  "Seuchengebundene Ergebene die bereits von Schleimiger Kadaver verwandelt wurden, bevor Ickor Gallenfleisch angegriffen wurde, geben keine feindlichen Kräfte."
...
L["Players can join the live session by either clicking this button or the Live Session chat link"] =
  "Spieler können der Live Sitzung beitreten indem sie entweder auf diesen Button oder auf einen Livesitzungs-Link im Chat klicken"
L["Please report any bugs on https://github.com/adi-no95/MDT_Legion/issues"] = "Bitte alle Fehler auf https://github.com/adi-no95/MDT_Legion/issues melden"
...
L["rookItemDescription"] =
  "Nach dem Besiegen von |cFFFF0000Kyrioss|r |cFF00FF00Sturmkrähenfeder|r aufnehmen. Wende sie auf eine in der Nähe befindliche |cFF00FF00Angekettete Sturmkrähe|r an, um diesen Buff für 5 Minuten zu erhalten."
...
L["siegeGutterNote2"] =
  "G72 Schlächter können für Streitkräfte verwendet werden. Hierzu müssen die Schlächter mit Schaden markiert werden und können dann mithilfe der Sofort-Tod Mechanik der Fußsoldaten bezwungen werden."
L["siegeGuttersNote"] =
  "Notiz für Schlächter:%sFußsoldaten werden ihre Sofot-Tod Mechanik auf Schlächter anweden, sobald ein Spieler nahe kommt. Falls ein Schlächter stirbt ohne Schaden von der Gruppe genommen zu haben werden keine Streitkräfte für die Gruppe berechnet."
...
L["tdBuffGateNote"] =
  "Chance einen Verbündeten zu enthalten, welcher einen Stärkungszauber basierend auf des Volkes wirken kann.%sOrk/Zweg: 10%%Str/Bew%sUntot/Mensch: 10%% Aus%sTauren/Draenei: 1%% HP+Mana alle 10s%sBlutelf/Gnom: 10%% Int"
...
L["The preset will continuously synchronize between all party members participating in the Live Session"] =
  "Die Route wird kontinuierlich zwischen allen Gruppenmitgliedern die an der Live Sitzung teilnehmen synchronisiert"
...
L["To share a different preset while the live session is active simply navigate to the preferred preset and click the new 'Set to Live' Button next to the preset-dropdown"] =
  "Wenn du eine andere Route während einer Live Sitzung teilen willst, dann gehe einfach zur gewünschten Route und klicke auf den neuen 'Zu Live machen' Button neben dem Routen Dropdown Menü"
...
L["WARNING_OLD_DUNGEON_IMPORT"] =
  "Diese Route ist für einen Dungeon, welcher in der aktuellen Version von MDT nicht verfügbar ist. Zum Importieren dieser Route MDT Legacy installieren."
...
L["You can always return to the current Live Session preset by clicking the 'Return to Live' button next to the preset-dropdown"] =
  "Du kannst immer zur aktuellen Live Sitzung zurückkehren, indem du auf den 'Zurück zur Live Sitzung'-Button neben dem Routen Dropdown clickst."
...
L["You can cycle through different floors by holding CTRL and using the mousewheel."] =
  "Du kannst mit gedrückter STRG-Taste und scrollen des Mausrads zwischen den verschiedenen Ebenen durchwechseln."
L["You can cycle through dungeons by holding ALT and using the mousewheel."] =
  "Du kannst mit gedrückter ALT-Taste und scrollen des Mausrads zwischen den verschiedenen Instanzen durchwechseln."
